          ...
          Find Me In
           ...
           <div className="flex justify-center items-center gap-20 text-9xl mt-10 flex-col lg:flex-row">
             <motion.a
              ...
              transition={{duration:0.8}} 
              style={{rotate}}  
              href="https://www.linkedin.com/in/nikos-karamaroudis-06676a233/" target="_blank"
             >
             ...
             <motion.a 
               ...
               transition={{duration:0.8}}           
               style={{rotate}}
              href="https://github.com/karamas13" target="_blank"
             >
             ...
             <motion.a 
              ...
              transition={{duration:0.8}}             
              style={{rotate}}
              href="https://www.instagram.com/nikos_krms/" target="_blank"
