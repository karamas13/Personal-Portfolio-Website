  ...
  return (
    <div className="border-b border-neutral-800 pb-24">
        <motion.h2 
         ...
         className="my-20 text-center text-4xl bg-gradient-to-r from-cyan-400 via-orange-600 to-green-500 bg-clip-text tracking-tight text-transparent w-fit mx-auto">Technologies</motion.h2>
        <motion.div 
